...
public:
    LiquidRocket(float throatA = 0.0f, float exitA = 0.0f, float injectorA = 0.0f, float heatRa = 0.0f, float gasC = 0.0f, float chamberT = 0.0f,
        float fuelD = 0.0f, float oxidizerD = 0.0f, float mixtureRatio = 0.0f, float shaftInertia = 0.0f, float pumpEff = 0.0f, float tankP = 0.0f,
        float propellantM = 0.0f, float dryM = 0.0f) {
